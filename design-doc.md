...
| 1.6 | Deployment Region set (owner, 2026-07-08) | Deploy Region fixed to **us-west-2** (owner's `bmaj` profile default); cost table relabeled; pricing unchanged vs us-east-1. Region-bound resources (KMS, buckets) are one-way doors. |
